 ...
 public class Mail
 {
   ...
   public Mail(Map<String, String> webSite, String to, String mailTemplate, String append, String title) {
     ...
     String content = ((String)webSite.get("mail_mailTemplate_" + mailTemplate)).replace("{append}", append);
   ...
   public Mail(String displayName, String to, String from, String smtpServer, String username, String password, String subject, String content, boolean ifAuth, String filename, Vector file)
   {
     this.displayName = displayName;
     this.to = to;
     this.from = from;
   ...
   {
     Mail mail = new Mail("小春", "504008147@qq.com", "forum4j@163.com", "smtp.163.com", "forum4j", "wozcc94", "标题", "内容", true, "小春", new Vector());
     mail.sendMail();
   }
 
   public static void simpleEmail() {
     Mail mail = new Mail("小春", "504008147@qq.com", "wzfz94264@163.com", "smtp.163.com", "wozcc94264", "wzfz94264", "标题", "内容", true, "小春", new Vector());
     mail.sendMail();
   }
