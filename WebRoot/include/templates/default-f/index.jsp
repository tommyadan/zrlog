...
<div class="container">
   <section class="row">
	...
	<header class="entry-header">
			...
			<a href="${rurl}post/${log.alias}" title="${log.title}">${log.title}</a>
	...
	<footer class="entry-footer clearfix visible-lg visible-md visible-sm">
		...
		<a class="pull-right more-link" href="${rurl}post/${log.alias}" title="阅读全文">阅读全文&raquo;</a>
			...
			<ul class='pagination pull-right'>
				...
				<li><A title="跳转到第一页" class="extend" href="${rurl}${requestScope.yurl}1">第一页 </A></li>
				<li><A href="${rurl}${requestScope.yurl}${requestScope.data.page-1}">上一页 </A></li>
				</c:if>
				<c:choose>
